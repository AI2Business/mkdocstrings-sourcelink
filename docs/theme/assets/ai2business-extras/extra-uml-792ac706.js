function _typeof(e) {
    ...
    var a, c, u = function (o) {
        ...
        var l = "undefined" == typeof mermaidConfig ? c : mermaidConfig[u] || mermaidConfig.default || c;
        ...
        for (var d = document.querySelectorAll("pre.".concat(o, ", mermaid-div")), f = document.querySelector("html"), s = function (e) {
                ...
                r.style.visibility = "hidden", r.style.display = "display", r.style.padding = "0", r.style.margin = "0", r.style.lineHeight = "initial", r.style.fontSize = "16px", f.appendChild(r);
                try {
                    mermaid.mermaidAPI.render("_mermaid_".concat(e), function (e) {
                        for (var t = "", n = 0; n < e.childNodes.length; n++) {
                            var o = e.childNodes[n];
                            if ("code" === o.tagName.toLowerCase())
                        ...
                        r.className = o, r.innerHTML = e;
                        var i = document.createElement("mermaid-div");
                        i.shadowRoot.appendChild(r), t.parentNode.insertBefore(i, t), n.style.display = "none", i.shadowRoot.appendChild(n), n !== t && t.parentNode.removeChild(t)
                    }), r)
                } catch (e) {}
    ...
    c = new MutationObserver((function (e) {
        e.forEach((function (e) {
            if ("attributes" === e.type) {
                ...
                t || (t = "default"), localStorage.setItem("data-md-color-scheme", t), "undefined" != typeof mermaid && u("mermaid")
            }
        }))
    })), a = function () {
    ...
    }, document.addEventListener("DOMContentLoaded", a), document.addEventListener("DOMContentSwitch", a)
}();
//# sourceMappingURL=extra-uml-792ac706.js.map